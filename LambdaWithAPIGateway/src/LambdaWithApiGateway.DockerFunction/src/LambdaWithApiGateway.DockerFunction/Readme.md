...
Execute unit tests
```
cd "LambdaWithApiGateway.DockerFunction/test/LambdaWithApiGateway.DockerFunction.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "LambdaWithApiGateway.DockerFunction/src/LambdaWithApiGateway.DockerFunction"
