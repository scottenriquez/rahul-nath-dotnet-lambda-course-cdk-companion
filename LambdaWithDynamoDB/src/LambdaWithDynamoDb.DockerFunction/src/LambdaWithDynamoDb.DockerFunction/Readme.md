...
Execute unit tests
```
cd "LambdaWithDynamoDb.DockerFunction/test/LambdaWithDynamoDb.DockerFunction.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "LambdaWithDynamoDb.DockerFunction/src/LambdaWithDynamoDb.DockerFunction"
