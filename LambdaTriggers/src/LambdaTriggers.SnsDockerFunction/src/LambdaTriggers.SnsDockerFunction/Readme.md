...
Execute unit tests
```
cd "LambdaTriggers.SnsDockerFunction/test/LambdaTriggers.SnsDockerFunction.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "LambdaTriggers.SnsDockerFunction/src/LambdaTriggers.SnsDockerFunction"
