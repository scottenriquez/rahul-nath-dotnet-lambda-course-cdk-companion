...
Execute unit tests
```
cd "LambdaTriggers.SqsDockerFunction/test/LambdaTriggers.SqsDockerFunction.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "LambdaTriggers.SqsDockerFunction/src/LambdaTriggers.SqsDockerFunction"
